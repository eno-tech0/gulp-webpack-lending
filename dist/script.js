...
/* harmony import */ var _modules_imagesAsModals__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/imagesAsModals */ "./src/js/modules/imagesAsModals.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var deadline = '2021-02-27';
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.decoration_item .no_click', '.decoration_content > div > div', 'after_click');
  ...
  Object(_modules_imagesAsModals__WEBPACK_IMPORTED_MODULE_6__["default"])('.works');
});
        ...
        switch (elem.nodeName) {
          ...
          case 'INPUT':
            if (elem.getAttribute('type') === 'checkbox') {
              ...
              elems.forEach(function (check, j) {
                check.checked = false;
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (number) {
...
var forms = function forms(state) {
  var mainForms = document.querySelectorAll('form'),
...
/***/ "./src/js/modules/imagesAsModals.js":
/*!******************************************!*\
  !*** ./src/js/modules/imagesAsModals.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var imagesAsModals = function imagesAsModals(selector) {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      var path = target.parentElement.getAttribute('href');
...
/* harmony default export */ __webpack_exports__["default"] = (imagesAsModals);
...
var modals = function modals(state) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.forEach(function (item) {
      return item.addEventListener('click', _closeModal__WEBPACK_IMPORTED_MODULE_1__["default"]);
    });
    modal.addEventListener('click', function (e) {
      return e.target === modal && closeClickOverlay ? Object(_closeModal__WEBPACK_IMPORTED_MODULE_1__["default"])() : null;
    });
  }
...
var tabs = function tabs(headerSelector, tabsSelector, contentsSelector, activeClass) {
  ...
  contents.forEach(function (content) {
    return content.classList.add('faded');
  });
...
var timer = function timer(id, deadline) {
  ...
  function addZero(num) {
    if (num < 0) return "0".concat(num);else return num;
  }
